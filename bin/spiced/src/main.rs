...
fn init_tracing() -> Result<(), Box<dyn std::error::Error>> {
    let filter = if let Ok(env_log) = std::env::var("SPICED_LOG") {
        ...
        EnvFilter::new("spiced=INFO,runtime=INFO,secrets=INFO,sql_provider_datafusion=INFO,data_components=INFO,cache=INFO,extensions=INFO,spice_cloud=INFO,pg_server=INFO")
    };

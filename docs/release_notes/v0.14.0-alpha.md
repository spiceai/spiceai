...
The v0.14-alpha release introduces MotherDuck and GraphQL data connectors and improves federated query stability.

## Highlights

- **MotherDuck Data Connector:** Added [MotherDuck](<[url](https://motherduck.com/)>) as a data source.

- **GraphQL Data Connector:** Added support for using GraphQL APIs as data sources.

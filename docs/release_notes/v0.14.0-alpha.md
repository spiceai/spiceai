...
- **Primary Keys and Indexes for Acceleration Engines**: Use indexes and primary keys with support of `upsert` or `drop` strategies for confliect resolution when accelerating data locally.

...
Spice v1.0.2 focuses on an improved developer experience, improved support for HuggingFace and Filesystem-hosted models, in addition to bug fixes.

## Highlights in v1.0.2

- **spice trace chat** Use new `spice trace chat` CLI command to get a detailed breakdown of recent chat interactions, including tool usage and AI completion steps:
...
- **Filesystem Hosted Models Provider:** Graduated to [Release Candidate (RC)](https://github.com/spiceai/spiceai/blob/trunk/docs/criteria/models/rc.md).

- **HuggingFace Models Provider:** Graduated to [Release Candidate (RC)](https://github.com/spiceai/spiceai/blob/trunk/docs/criteria/models/rc.md).

- **Models Grading:** Introduced [Models Grading](https://github.com/spiceai/spiceai/blob/trunk/docs/criteria/models/grading.md) to classify a model's capabilities when used with the Spice Runtime.

## New Contributors

- @johnnynunez made their first contribution in https://github.com/spiceai/spiceai/pull/4502
...
- Added [Filesystem Hosted Model](https://github.com/spiceai/cookbook/blob/trunk/models/filesystem/)

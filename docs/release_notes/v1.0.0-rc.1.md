# Spice v1.0-rc.1 (Nov 25, 2024)

Spice v1.0.0-rc.1 marks the release candidate for the first major version of Spice, bringing numerous improvements, new features, and bug fixes. The DuckDB Data Connector along with the Arrow and DuckDB Data Accelerators has graduated from Beta to Release Candidates.

## Highlights in v1.0-rc.1

**Data Connectors:** The `DuckDB` Data Accelerator has graduated from `beta` to `release candidate`.

**Data Accelerators:** The `Arrow` and `DuckDB` Data Accelerators has graduated from `beta` to `release candidate`.

## Breaking changes

Models `params.tools` parameter replaces `params.spice_tools`, with backwards compatibility for `params.spice_tools`.

Dataset accelerator `ready_state` parameter has been moved to the dataset level.

The following metrics have been changed:

| **Before**                                       | **Unit**         | **v1.0-rc.1**                                        |
|------------------------------------------------------------|------------------|-----------------------------------------------------|
| catalogs_load_error                                        | counter          | catalog_load_errors                                 |
| catalogs_status                                            | component_status                | catalog_load_state                                  |
| datasets_acceleration_append_duration_ms, datasets_acceleration_load_duration_ms                  | ms               | dataset_acceleration_refresh_duration_ms {mode: append/full} |
| datasets_acceleration_last_refresh_time                   | s->ms            | dataset_acceleration_last_refresh_time_ms          |
| datasets_acceleration_refresh_error                       | counter          | dataset_acceleration_refresh_errors                |
| datasets_count                                             | counter                | dataset_active_count                               |
| datasets_load_error                                        | counter          | dataset_load_errors                                |
| datasets_status                                            | component_status                | dataset_load_state                                 |
| datasets_unavailable_time                                  | s->ms            | dataset_unavailable_time_ms                       |
| embeddings_count                                           | counter                | embeddings_active_count                           |
| embeddings_load_error                                      | counter          | embeddings_load_errors                            |
| embeddings_status                                          | component_status                | embeddings_load_state                             |
| flight_do_action_duration_ms, flight_do_get_get_primary_keys_duration_ms, flight_do_get_get_catalogs_duration_ms, flight_do_get_get_schemas_duration_ms, flight_do_get_get_sql_info_duration_ms, flight_do_get_table_types_duration_ms, flight_do_get_get_tables_duration_ms, flight_do_get_prepared_statement_query_duration_ms, flight_do_get_simple_duration_ms, flight_do_get_statement_query_duration_ms, flight_do_put_duration_ms, flight_handshake_request_duration_ms, flight_list_actions_duration_ms, flight_get_flight_info_request_duration_ms | ms | flight_request_duration_ms {method: method_name, command: command_name}                       |
| flight_do_action_requests, flight_do_exchange_data_updates_sent, flight_do_exchange_requests, flight_do_put_requests, flight_do_get_requests, flight_handshake_requests, flight_list_actions_requests, flight_list_flights_requests, flight_get_flight_info_requests, flight_get_schema_requests | counter | flight_requests {method: method_name, command: command_name}                                      |
| http_requests_duration_ms                                  | ms               | http_request_duration_ms                          |
| models_count                                               | counter                | model_active_count                                |
| models_load_duration_ms                                    | ms               | model_load_duration_ms                           |
| models_load_error                                          | counter          | model_load_errors                                |
| models_status                                              | component_status                | model_load_state                                 |
| tool_count                                                 | counter                | tool_active_count                                |
| tool_load_error                                            | counter          | tool_load_errors                                |
| tools_status                                               | component_status                | tool_load_state                                 |
| query_count                                                | counter          | query_executions                                 |
| query_execution_duration                                   | ms               | query_execution_duration_ms                     |
| results_cache_hit_count                                    | counter          | results_cache_hits                              |
| results_cache_item_count                                   | counter->gauge   | results_cache_items_count                       |
| results_cache_max_size                                     | bytes    | results_cache_max_size_bytes                   |
| results_cache_request_count                                | counter          | results_cache_requests                          |
| results_cache_size                                         | bytes    | results_cache_size_bytes                        |
| secrets_stores_load_duration_ms                            | ms               | secrets_store_load_duration_ms                 |
| bytes_processed                                            | bytes       | query_processed_bytes                          |
| bytes_returned                                             | bytes       | query_returned_bytes                           |
| spiced_runtime_flight_server_start                         | counter          | runtime_flight_server_started                  |
| spiced_runtime_http_server_start                           | counter          | runtime_http_server_started                    |
| views_load_error                                           | counter          | view_load_errors                               |
...
**Full Changelog**: https://github.com/spiceai/spiceai/compare/v0.20.0-beta...v1.0-rc.1

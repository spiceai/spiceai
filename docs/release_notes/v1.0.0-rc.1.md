...
Spice v1.0.0-rc.1 marks the release candidate for the first major version of Spice, bringing numerous improvements, new features, and bug fixes. The Arrow and DuckDB Data Accelerators have graduated from Beta to Release Candidates.

...
Spice v1.0.0-rc.2 is the second release candidate for the first major version of Spice.ai OSS. This milestone continues to build on the stability of Spice for production use, including key Data Connector graduations, bug fixes, and AI features.

## Highlights in v1.0-rc.2

**MS SQL, File Data Connectors:** have graduated from Alpha to Beta.

**GraphQL, Databricks Delta Lake Data Connectors:** have graduated from Beta to Release Candidate.

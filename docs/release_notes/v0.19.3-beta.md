...
Spice v0.19.3-beta includes enhanced performance for federated queries across multiple sources, and improved stability of data connectors and accelerators.

## Highlights in v0.19.3

**Improved performance of federated queries containing multiple sources**: Faster queries across multiple federated sources by optimizing when filters are applied.

...
**Improved Postgres Connector** The [PostgreSQL Connector](https://docs.spiceai.org/components/data-connectors/postgres) can now connect to empty tables, and extract schemas from them.

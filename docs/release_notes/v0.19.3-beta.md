...
Spice v0.19.3-beta includes support for Anthropic language models, enhanced performance for federated queries across multiple sources, and improved stability of data connectors and accelerators.

## Highlights in v0.19.3

**Anthropic Language Model Support:** Spice now supports [Anthropic](https://docs.spiceai.org/components/models/anthropic) language models.
...
**GitHub Connector Beta Release:** The [GitHub Connector](https://docs.spiceai.org/components/data-connectors/github) has graduated to Beta after extensive testing, and stability and performance improvements.  

**Improved performance of federated queries containing multiple sources**: Faster queries across multiple federated sources by optimizing how filters are applied.

**Improved PostgreSQL Connector** The [PostgreSQL Connector](https://docs.spiceai.org/components/data-connectors/postgres) can now connect to empty tables, and extract schemas from them.

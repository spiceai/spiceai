...
- fix: propagate spark feature to connector-databricks by [@phillipleblanc](https://github.com/phillipleblanc) in [#9586](https://github.com/spiceai/spiceai/pull/9586)
- fix: Bump spice-rs SDK to fix async query response deserialization by [@phillipleblanc](https://github.com/phillipleblanc) in [#9588](https://github.com/spiceai/spiceai/pull/9588)

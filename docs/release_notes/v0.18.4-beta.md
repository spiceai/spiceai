...
For a full list of supported parameters and authentication options, see the [Object Store File Formats](/components/data-connectors/index.md#object-store-file-formats) documentation.

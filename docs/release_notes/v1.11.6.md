...
The Spice [Helm chart](https://spiceai.org/docs/deployment/kubernetes) now supports configurable `livenessProbe`, `readinessProbe`, and `startupProbe` settings ([#10696](https://github.com/spiceai/spiceai/pull/10696)). Probe paths, ports, and timing parameters can now be customized directly in chart values.

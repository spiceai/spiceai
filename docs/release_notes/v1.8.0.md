...
Firstly, the [`document_similarity`](https://spiceai.org/docs/components/tools#available-tools) has been renamed to `search`. This has the equivalent change to tracing of these tool calls:
```bash
## Old: v1.7.1

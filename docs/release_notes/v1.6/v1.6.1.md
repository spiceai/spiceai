...
Spice 1.6.1 provides improved kafka type inference and JSON flattening support, and several patch fixes: for the `v1/models` endpoint and addresses an issue in DataFusion around UDTF caching, and corrects unparsing for custom SQL dialects.

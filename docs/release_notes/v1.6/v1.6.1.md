...
- Skip dataset health check for IcebergTableProvider datasets (#6995) by [@phillipleblanc](https://github.com/phillipleblanc) in [#6995](https://github.com/spiceai/spiceai/pull/6995)
- Update build_and_release macOS pipeline to skip updating cmake if installed (#6998) by [@phillipleblanc](https://github.com/phillipleblanc) in [#6998](https://github.com/spiceai/spiceai/pull/6998)
- Spice CLI trace: make error friendlier when task_history is disabled (#6996) by [@sgrebnov](https://github.com/sgrebnov) in [#6996](https://github.com/spiceai/spiceai/pull/6996)
Add v1.6.1 release notes (#7000) by [@lukekim](https://github.com/lukekim) in  [#7000](https://github.com/spiceai/spiceai/pull/7000)

...
- **Databricks Service Principal Support**: Databricks datasets, catalogs, and models now support Machine-to-Machine (M2M) OAuth authentication via Service Principals, enabling secure machine connections to Databricks.
...
- [Databricks Model Provider](https://spiceai.org/docs/components/models/databricks)

...
- **M2M OAuth for Databricks**: Databricks datasets and catalogs connectors and models provider can be configured to use Databricks Service Principal (M2M OAuth).

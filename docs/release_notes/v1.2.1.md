...
- Infer partitions from schema_source_path if present by [@phillipleblanc](https://github.com/phillipleblanc) in [#5721](https://github.com/spiceai/spiceai/pull/5721)

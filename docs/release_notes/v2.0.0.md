...
- **[Dependency upgrades](#dependency-updates)** including **DataFusion v52.5**, **DuckDB v1.5.3**, **Arrow v57.2**, **iceberg-rust v0.9.1**, **Turso v0.6.0**, and **Vortex v0.69**
...
[Distributed Query](https://spiceai.org/docs/features/distributed-query) is generally available with multi-active highly-available, object-store-native distributed query.

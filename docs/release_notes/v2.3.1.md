...
- [**Cayenne Memory-Mode DML**](#cayenne-memory-mode-dml-works-as-expected) — `DELETE`, `UPDATE`, and `INSERT` is now supported when the acceleration uses the default in-memory mode

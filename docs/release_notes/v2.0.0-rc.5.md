...
- **Cayenne** — CDC throughput, compaction and scan caching, synchronized partition commits, join filter propagation, parallel Vortex writes, lock-free deletion caches
...
- [@claudespice](https://github.com/claudespice)

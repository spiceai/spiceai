...
- Cayenne perf: eliminate redundant clones, PK point-lookup fanout fix, IN-list rewrite + microbench coverage by[@lukekim](https://github.com/lukekim) in [#10916
(https://github.com/spiceai/spiceai/pull/10916)
- fix(turso-shared): retry on Turso BEGIN CONCURRENT "Write-write conflict" by[@lukekim](https://github.com/lukekim) in [#10946](https://github.com/spiceai/spiceai/pull/10946)
- Vendor Vortex DataFusion for Cayenne by[@lukekim](https://github.com/lukekim) in [#10933](https://github.com/spiceai/spiceai/pull/10933)
- perf(cayenne): background retention + enable CDC pipelining for retention-configured tables by[@lukekim](https://github.com/lukekim) in [#10936
(https://github.com/spiceai/spiceai/pull/10936)
- feat(cayenne): scale metastore pool to 32 + vs_duckdb_scaling benches (1→128 concurrency, sqlite + turso lanes) by[@lukekim](https://github.com/lukekim) in [#10943
(https://github.com/spiceai/spiceai/pull/10943)
- build(deps): bump ubuntu from 24.04 to 26.04 in the docker-dependencies group by[@app/dependabot](https://github.com/apps/dependabot) in [#10883
(https://github.com/spiceai/spiceai/pull/10883)

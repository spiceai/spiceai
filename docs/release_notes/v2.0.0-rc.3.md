...
- **Databricks and Unity Catalog Reliability Improvements** with resilience controls, UC-aware behavior, advisory permission checks, and structured error reporting
...
The [HTTP connector](https://spiceai.org/docs/components/data-connectors/http) now supports more authentication and API response patterns, making it easier to integrate with modern REST APIs.
...
Spice improves telemetry export reliability and authenticated metrics delivery.
...
| **futures**                      | v0.3.32                                            |
| **sysinfo**                      | v0.38.4                                            |
| **AWS SDK group**                | Updated across multiple crates                     |
...
- **Kafka Connector Fixes**: Improved reliability for Kafka connector behavior.
- **GitHub Connector Resilience**: Improved commit fetching for dynamic and slash refs, and reduced GraphQL page sizes on gateway errors.

...
The 0.12.0-alpha release introduces Clickhouse and Spark data connectors, support for temporal refresh data periods. In addition, official Spice Client SDKs released with support for Spice OSS, and overall stability improvements have been added.

## Highlights

- **Clickhouse data connector**: Use Clickhouse as a data source.

- **Spark data connector**: Use Spark as a data source.
...
- **Spice Client SDK Support**: Official Spice.ai SDKs have been released with support for Spice OSS.
  - https://github.com/spiceai/spice-rs/releases/tag/v2.0.0
  - https://github.com/spiceai/spice.js/releases/tag/v2.0.0
  - https://github.com/spiceai/gospice/releases/tag/v6.0.0
  - https://github.com/spiceai/spicepy/releases/tag/v2.0.0

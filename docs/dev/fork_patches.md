...
| [datafusion](#datafusion) | `6006901cb602d845ee1441269d6eaa142c2580a6` | `spiceai-54` |
...
| [datafusion-table-providers](#datafusion-federation-and-datafusion-table-providers) | `7752b0ed353597d6f83686a698fe21535d5a9ba1` | `spiceai-54` |
...
| Substrait `VarChar` literals (`LiteralType::VarChar` → `ScalarValue::Utf8`) (fork PR #215) | Isthmus TPC-H plans emit `VarChar` literals (`EUROPE`, length 25). Without the patch `from_substrait_plan` errors (`Unsupported literal_type: Some(VarChar(...))`) and Mode A reports ERROR instead of executing — 13/22 queries on the pre-#215 pin | silent (query failure) | `tools/substrait-compliance/src/mode_a.rs::varchar_literal_lowers_to_utf8`; Mode A harness (`spice-substrait-compliance`) on q02/q03/q05/q11/q12/q16/q17/q19–q22 |

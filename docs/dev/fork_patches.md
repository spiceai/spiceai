...
| [datafusion](#datafusion) | `c89b332084d893ee5feeae19974f37a4427558d6` | `spiceai-54` |
...
| Unparser: refuse an `EXISTS` bound that cannot be scoped, rather than emit wrong rows (fork PRs #205, #207) | The unparser silently emits SQL that returns wrong rows for the shapes it cannot scope — including a correlation the probe qualifier or the body itself captures ([#13277](https://github.com/spiceai/spiceai/issues/13277), [#12840](https://github.com/spiceai/spiceai/issues/12840)) | silent (wrong data) | `…::a_bounded_exists_refuses_a_correlation_naming_two_build_inputs`, `…::an_exists_refuses_a_correlation_the_probe_qualifier_captures_at_any_bound`, `…::an_exists_refuses_an_unqualified_correlation_the_body_exposes`, `…::an_exists_keeps_an_unqualified_correlation_the_body_lacks`, `…::an_exists_keeps_a_correlation_no_relation_in_the_body_answers_to` |

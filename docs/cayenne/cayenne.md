...
| `cayenne_datalake_warm_max_bytes` / `_max_files` | warm→datalake promotion triggers (size / file count) | 16 × cold target file size / (unset) |
| `cayenne_datalake_background_interval_ms` | datalake promoter cadence | `60_000` |

...
```mermaid
flowchart TB
    Q["WHERE id = 42"] --> SEL["key-selective (PK literal, short IN/BETWEEN, or index hit)?<br/>yes: one file group, files opened one after another<br/>no: files spread over target_partitions"]

...
| 2026-08-25 | PR #13373 | A rewrite's shards are cut at equal cumulative row mass from the per-partition bands its inputs report, not equi-width over the reported key range. |

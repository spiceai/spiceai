...
func (x *Interpretation) GetStart() uint64 {
	if x != nil {
		return x.Start
	}
	return 0
...
func (x *Interpretation) GetEnd() uint64 {
	if x != nil {
		return x.End
	}
	return 0
...
type IndexedInterpretations struct {
	...
	Index           map[uint64]*InterpretationIndices `protobuf:"bytes,2,rep,name=index,proto3" json:"index,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *IndexedInterpretations) GetIndex() map[uint64]*InterpretationIndices {
	if x != nil {
		return x.Index
	}
	return nil
...
var file_proto_common_v1_common_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x33, 0x0a, 0x05, 0x76, 0x61, 0x6c,
...
var file_proto_common_v1_common_proto_goTypes = []interface{}{
	...
	(*InterpretationIndices)(nil),  // 1: common.InterpretationIndices
	(*IndexedInterpretations)(nil), // 2: common.IndexedInterpretations
	nil,                            // 3: common.IndexedInterpretations.IndexEntry
}
var file_proto_common_v1_common_proto_depIdxs = []int32{
	0, // 0: common.IndexedInterpretations.interpretations:type_name -> common.Interpretation
	3, // 1: common.IndexedInterpretations.index:type_name -> common.IndexedInterpretations.IndexEntry
	1, // 2: common.IndexedInterpretations.IndexEntry.value:type_name -> common.InterpretationIndices

...
Evals for the rules in `AGENTS.md` (symlinked as
`CLAUDE.md` and `.github/copilot-instructions.md`) — the instructions every agent working in this repo runs under.

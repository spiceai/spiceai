...
1. **E2E Tests**
   ...
   - [ ] Verify [Test Operator Benchmarks](https://github.com/spiceai/spiceai/actions/workflows/testoperator_run_bench.yml) is green on `trunk` and the release branch.
     ...
     - [ ] Manually dispatch the DynamoDB benchmarks by specifying the spicepod path:
       - [ ] `tpch/sf1/accelerated/dynamodb-arrow.yaml`
       - [ ] `tpch/sf1/accelerated/dynamodb-duckdb[file].yaml`
       - [ ] `tpch/sf1/federated/dynamodb.yaml`

-- using 1711329383 as a seed to the RNG
...
from
	(
		...
		where
			...
			and (
				(n1.n_name = 'ARGENTINA' and n2.n_name = 'RUSSIA')
				or (n1.n_name = 'RUSSIA' and n2.n_name = 'ARGENTINA')
			)
...
where
	...
	and p_size in (5, 1, 8, 42, 25, 35, 43, 40)

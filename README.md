...
- **[v2.3](https://github.com/spiceai/spiceai/blob/trunk/docs/release_notes/v2.3.2.md)** (shipped, September 2026) — Schema Registry (initial), full UPDATE/DELETE DML on write-through accelerated tables, and DataFusion v55.

...
/// `MongoDB` resume-token store backed by a `PostgreSQL` accelerator.
pub struct PostgresMongoCheckpointStore {
    pool: Arc<PostgresConnectionPool>,
    dataset_name: String,
}

impl PostgresMongoCheckpointStore {
    #[must_use]
...
#[async_trait]
impl MongoCheckpointStore for PostgresMongoCheckpointStore {

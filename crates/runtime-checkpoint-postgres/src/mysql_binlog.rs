...
/// `MySQL` binlog position store backed by a `PostgreSQL` accelerator.
pub struct PostgresMySqlBinlogStore {
    pool: Arc<PostgresConnectionPool>,
    dataset_name: String,
}

impl PostgresMySqlBinlogStore {
    #[must_use]
...
#[async_trait]
impl MySqlBinlogStore for PostgresMySqlBinlogStore {

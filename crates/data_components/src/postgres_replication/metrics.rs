...
impl MetricsCollector {
    ...
    /// (shared slot).
    pub(crate) fn inc_envelope_delivered(&self) {
    ...
    pub(crate) fn inc_envelope_merged_eager(&self) {
    ...
    pub(crate) fn inc_envelope_merged_mailbox(&self) {
    ...
    pub(crate) fn inc_mailbox_coalesce_limited(&self) {

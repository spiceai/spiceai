...
impl Read for ScyllaDbTableFactory {
    async fn table_provider(
        ...
        // Note: ScyllaDB uses CQL (Cassandra Query Language), not SQL.
        // CQL does not support SQL constructs like CASE expressions, subqueries,
        // COUNT(DISTINCT), complex joins, etc. Therefore we do NOT create a
        // federated table provider. Complex queries will be handled locally
        // by DataFusion after fetching the data from ScyllaDB.

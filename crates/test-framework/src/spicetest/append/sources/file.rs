    ...
    async fn setup(&self, config: &AppendConfig) -> Result<()> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            match query_set {
                ...
                QuerySet::Scenario { .. } | QuerySet::ParameterizedTpch | QuerySet::ChBench | QuerySet::ChBenchFts => anyhow::bail!("Appendable file source is not implemented for Scenario, Parameterized TPC-H, or CH-benCH query sets"),
            }
    ...
    async fn generate(&self, config: &AppendConfig, load_index: u16) -> Result<()> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let sql = match query_set {
                ...
                QuerySet::Scenario { .. } | QuerySet::ParameterizedTpch | QuerySet::ChBench | QuerySet::ChBenchFts => {

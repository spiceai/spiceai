...
//! entries; we translate the shape and reuse the shared index→score mapper.
...
const DEFAULT_MODEL: &str = "rerank-2";
...
#[async_trait]
impl Rerank for VoyageReranker {

...
use super::{
    CompoundReadMode, CompoundVectorIndex, Error, compound_lifecycle_both, compound_on_write_start,
...
impl Index for CompoundSearchIndex {
    ...
    fn required_columns(&self) -> Vec<String> {
        compound_required_columns(&self.primary, &self.secondary)
    }
    ...
    async fn on_write_start(&self) -> Result<(), DataFusionError> {
        compound_on_write_start(&self.primary, &self.secondary).await
    }

    async fn on_write_failed(&self) -> Result<(), DataFusionError> {
        compound_lifecycle_both(
...
impl SearchIndex for CompoundSearchIndex {
    ...
    async fn write(
        ...
        compound_write(&self.primary, &self.secondary, record).await
    }

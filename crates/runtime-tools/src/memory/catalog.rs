...
use crate::factory::IndividualToolFactory;
use app::App;
...
use super::store::StoreMemoryTool;
...
impl MemoryToolCatalog {
    #[must_use]
    pub fn new(df: Arc<dyn QueryEngine>, app: Arc<RwLock<Option<Arc<App>>>>) -> Self {
        Self { df, app }
    }

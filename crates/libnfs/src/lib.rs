...
mod sys {
    ...
    // Bindgen generates `extern "C"` blocks which in Rust 2024 should be
    // `unsafe extern "C"`, but we're using Edition 2021 for bindgen output
    // compatibility and wrapping with unsafe where needed.
...
impl NfsFile {
    ...
    pub fn pread(&self, count: u64, offset: u64) -> Result<Vec<u8>> {
        ...
        unsafe {
            ...
            // SAFETY: read_size is non-negative after check_retcode succeeds

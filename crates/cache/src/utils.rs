...
pub(crate) mod tests {
    ...
    async fn test_collect_table_names_system_query_describe() {
        ...
        (table_names == expected).then_some(()).expect("table_names should match expected for DESCRIBE query");
    }
    ...
    async fn test_collect_table_names_system_query_show_tables() {
        ...
        (table_names == expected).then_some(()).expect("table_names should match expected for SHOW TABLES query");
    }
    ...
    async fn test_collect_table_names_simple_select() {
        ...
        (table_names == expected).then_some(()).expect("table_names should match expected for simple SELECT query");
    }
    ...
    async fn test_collect_table_names_join() {
        ...
        (table_names == expected).then_some(()).expect("table_names should match expected for JOIN query");
    }
    ...
    async fn test_collect_table_names_subquery() {
        ...
        (table_names == expected).then_some(()).expect("table_names should match expected for subquery");
    }
    ...
    async fn test_collect_table_names_nested_subqueries_with_aliases() {
        ...
        let expected: HashSet<TableReference> = HashSet::from(["customer".into(), "orders".into()]);
        (table_names == expected).then_some(()).expect("table_names should match expected for nested subqueries with aliases");
    }
    ...
    async fn test_collect_table_names_union_with_subqueries() {
        ...
        let expected: HashSet<TableReference> = HashSet::from(["customer".into(), "orders".into()]);
        (table_names == expected).then_some(()).expect("table_names should match expected for UNION with subqueries");
    }
    ...
    async fn test_collect_table_names_join_with_subquery_in_from_clause() {
        ...
        let expected: HashSet<TableReference> = HashSet::from(["customer".into(), "orders".into()]);
        (table_names == expected).then_some(()).expect("table_names should match expected for JOIN with subquery in FROM clause");
    }

    ...
    let queries: QueryTests = vec![
        ...
        (
            ...
            vec![
                ...
                "|               |         TableScan: eth.recent_transactions                                                                                                                                                                                                                                                                          |",
                "| physical_plan | VirtualExecutionPlan name=spiceai compute_context=url=https://flight.spiceai.io,username= sql=SELECT \"eth\".\"recent_blocks\".\"number\" FROM \"eth\".\"recent_blocks\" UNION ALL SELECT \"eth\".\"recent_transactions\".\"block_number\" AS \"number\" FROM \"eth\".\"recent_transactions\" ORDER BY \"number\" DESC NULLS FIRST LIMIT 10 |",
                "|               |                                                                                                                                                                                                                                                                                                                     |",
                "+---------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+",
            ],
            Some(Box::new(|result_batches| {

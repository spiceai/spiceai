    ...
    let queries = vec![
        ...
        (
            ...
            vec![
                ...
                "|               |     SubqueryAlias: blocks                                                                                                                                                                                                               |",
                "|               |       TableScan: eth.recent_blocks                                                                                                                                                                                                      |",
                "| physical_plan | VirtualExecutionPlan name=spiceai compute_context=url=https://flight.spiceai.io,username= sql=SELECT \"blocks\".\"number\" FROM \"eth\".\"recent_blocks\" AS \"blocks\" WHERE (\"blocks\".\"number\" = (SELECT MAX(\"blocks\".\"number\") FROM \"blocks\")) |",
                "|               |                                                                                                                                                                                                                                         |",
                "+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+",
            ],
            Some(has_one_int_val),

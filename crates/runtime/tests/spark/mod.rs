    ...
    dataset.params = Some(Params::from_string_map(
        vec![(
            ...
            format!(
                ...
                std::env::var("TEST_DATABRICKSCKS_HOST").unwrap_or_default(),
                uuid::Uuid::new_v4(),
                std::env::var("TEST_DATABRICKSCKS_TOKEN").unwrap_or_default(),
                std::env::var("TEST_DATABRICKSCKS_CLUSTER_ID").unwrap_or_default(),
            ),
        )]
            .into_iter()
            .collect(),

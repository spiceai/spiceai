...
use crate::{config, datafusion::DataFusion, ducknsql::CandleLlama, model::Model};
...
{
    let routes = routes::routes(app, df, models, nsql, config, with_metrics);

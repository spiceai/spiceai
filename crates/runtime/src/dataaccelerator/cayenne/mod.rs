...
/// `crate::builder::can_compact_into_carve`.
///
...
mod tests {
    ...
    async fn test_orphaned_dv_cleanup_param_zero_and_unset_disable() {
        ...
        let unset = DatasetBuilder::try_new("orphan_unset".to_string(), "orphan_unset")
            ...
            .build()
            .expect("dataset");
        let unset_config = CayenneAccelerator::get_vortex_config("orphan_unset", &unset)
            .await
            .expect("config should be valid");
        assert_eq!(
        ...
        let zero_config = CayenneAccelerator::get_vortex_config("orphan_zero", &zero)
            .await
            .expect("config should be valid");
        assert_eq!(

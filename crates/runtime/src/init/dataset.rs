...
impl Runtime {
    ...
    // Only reached via the postgres-accelerated catalog connector
    // (`catalogconnector::postgres_accelerated`, itself `#[cfg(feature = "postgres")]`),
    // so it is dead code in a build with that feature off.

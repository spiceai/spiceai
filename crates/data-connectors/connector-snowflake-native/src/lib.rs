...
//! Snowflake native API data connector for Spice.ai runtime.
//!
//! Uses the `snowflake_api` crate for direct Snowflake connectivity,
//! distinct from the ODBC-based `connector-snowflake`.

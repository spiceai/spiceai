...
impl TableProvider for WorkflowRunsTableProvider {
    ...
    async fn scan(
        ...
        tracing::debug!(
            ...
            pushed_down_filters = ?query_params,
            remaining_filters = ?remaining_filters,
            "Computed GitHub workflow run filter pushdown"
        );
...
impl ExecutionPlan for WorkflowRunsExecutionPlan {
    ...
    ) -> datafusion::error::Result<Option<datafusion_proto_models::protobuf::PhysicalPlanNode>>
    {
        Ok(None)
    }

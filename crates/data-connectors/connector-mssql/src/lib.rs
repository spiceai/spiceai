...
//! `MS SQL Server` data connector for Spice.ai runtime.
//!
//! This crate provides the `MS SQL Server` connector implementation, allowing
//! Spice.ai to connect to Microsoft SQL Server databases as data sources.
//!
...
/// Factory for creating `MS SQL Server` connector instances.
